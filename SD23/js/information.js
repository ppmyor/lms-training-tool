...
const page2 =
    "비플제로페이는 회원가입이 필요합니다. 실습에서 입력한 정보는 저장 및 전송되지 않습니다. 회원가입을 위해 이름을 입력하고 엔터 또는 확인을 눌러주세요.";
...
const page8 = "통신사가 선택되었습니다. 휴대폰 번호를 숫자만 입력하고 엔터 또는 확인을 눌러주세요.";
const page9 = "인증 문자를 받기 위해 화면 하단 파란색 인증 문자 받기 버튼을 눌러주세요. ";
const page10 =
    "인증번호 받기를 누르면 비플제로페이 사용을 위한 약관이 안내됩니다. '약관에 모두 동의' 왼쪽 동그라미 부분을 눌러서 체크해 주세요.";
const page11 = "약관에 동의하고 화면 하단 다음 버튼을 누르면 인증번호가 휴대폰으로 전송됩니다.";
const page12 =
    "휴대폰 문자로 인증번호가 발송됩니다. 휴대폰에 수신된 인증번호를 입력합니다. 실습에서는 입력 창을 눌러서 224973을 입력하고 엔터 또는 확인을 눌러주세요.";
const page13 = "인증번호가 입력되었습니다. 파란색 인증 완료 버튼을 눌러주세요.";
const page14 = "본인인증이 완료되었습니다. 확인을 눌러 다음으로 진행해 주세요";
const page15 =
    "비플제로페이 회원가입이 완료되었습니다. 비플제로페이를 사용하려면 6자리 숫자로 된 거래 승인번호 설정이 필요합니다. '거래승인번호 설정하기'를 눌러주세요.";
const page16 =
    "여섯 자리 숫자로 거래 승인번호를 설정하겠습니다. 거래 승인번호는 결제할 때 비밀번호로 사용됩니다. 실습에서는 202112로 설정하겠습니다. 첫 번째 자리 2를 입력해 주세요.";
...
const page22 = "방금 설정한 거래 승인번호 202112를 다시 한번 입력해 주세요. 첫 번째 자리 2를 입력해 주세요.";
...
const page28 =
    "비밀번호 설정이 완료되었습니다. 이제 비플제로페이를 사용할 준비가 되었습니다. 다음 시간에는 비플제로페이에 계좌를 연결하는 실습을 진행하겠습니다.";
...
const coordinate2 = {
    ...
    startRateY: 0.2015267175572519,
    endRateX: 0.9121813031161473,
    endRateY: 0.2732824427480916,
};
...
const coordinate4 = {
    ...
    startRateY: 0.3267175572519084,
    endRateX: 0.46742209631728043,
    endRateY: 0.39083969465648855,
};

const coordinate5 = {
    startRateX: 0.6062322946175638,
    startRateY: 0.3893129770992366,
    endRateX: 0.5382436260623229,
    endRateY: 0.3236641221374046,
};
