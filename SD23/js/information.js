...
const page1 =
    "간편결제 서비스 비플제로페이는 가맹점에서 간편하게 결제가 가능하고, 특히 동네 상권에서 유용하게 활용할 수 있습니다. 비플제로페이 첫 화면을 눌러서 다음 단계로 진행해 주세요.";
const page2 =
    "비플제로페이는 회원가입 후 이용할 수 있습니다. 회원가입을 진행하겠습니다. 이름을 입력해 주세요. 실습에서는 김서울을 입력하고 엔터 또는 확인을 눌러주세요.";
const page3 = "이름이 입력되었습니다. 하단에 파란색 다음 버튼을 눌러주세요.";
const page4 =
    "본인 인증을 위한 생년월일과 주민등록번호 뒷자리 첫 번째 자리를 입력하겠습니다. 실습에서는 개인 정보보호를 위해 주민등록번호 앞자리와 뒷자리는 자동으로 입력하였습니다. 화면을 눌러서 다음으로 진행해 주세요.";
const page5 = "주민등록번호 앞자리와 뒷자리는 자동으로 입력되었습니다. 화면을 눌러서 다음으로 진행해 주세요.";
const page6 =
    "본인 인증에 사용할 휴대폰 통신사를 선택해 주세요. 통신사 선택 셀렉트 박스를 열기 위해 통신사 항목을 눌러주세요.";
const page7 =
    "리스트에서 총 6가지 통신사 유형을 확인할 수 있습니다. 실습에서는 첫 번째 SKT 통신사를 선택하겠습니다. SKT를 눌러서 선택해 주세요.";
const page8 =
    "통신사 선택까지 완료되었습니다. 휴대폰 번호를 입력해 주세요. 실습에서는 0,1,0,1,2,3,4,5,6,7,8을 입력하겠습니다. 전화번호를 입력하고 엔터 또는 확인을 눌러주세요.";
const page9 = "인증 문자를 받기 위해 화면 하단 파란색 인증 문자 받기 버튼을 클릭해 주세요. ";
const page10 =
    "인증번호 받기를 누르면, 비플제로페이를 사용을 위한 약관이 안내됩니다. 약관에 모두 동의 왼쪽, 동그라미 부분을 눌러서 체크해 주세요.";
const page11 = "약관에 동의한 후 화면 하단 다음 버튼을 누르면 인증번호가 휴대폰으로 전송됩니다.";
const page12 =
    "휴대폰에 문자로 인증번호가 발송되었습니다. 휴대폰에 수신된 인증번호를 입력해 주세요. 실습에서는 입력 창을 눌러서 2,2,4,9,7,3을 입력해 주세요.";
const page13 = "인증번호 입력이 완료되었습니다. 파란색 인증 완료 버튼을 눌러주세요.";
const page14 = "본인인증이 완료되었습니다. 확인을 눌러 다음으로 진행해 주세요";
const page15 =
    "비플제로페이 회원가입이 완료되었습니다. 비플제로페이를 사용하려면 거래 승인번호를 설정해야 합니다. 거래 승인번호는 6자리 비밀번호입니다. 설정하기를 눌러주세요.";
const page16 =
    "여섯 자리의 거래 승인번호를 설정해 보겠습니다. 이 거래 승인번호는, 결제를 할 때 비밀번호로 사용됩니다. 실습에서는 2,0,2,1,1,2로 설정하겠습니다. 첫 번째 자리 2를 입력해 주세요.";
const page17 = "2,0,2,1,1,2 의 두 번째 자리 0를 입력해 주세요.";
const page18 = "2,0,2,1,1,2 의 세 번째 자리 2를 입력해주세요.";
const page19 = "2,0,2,1,1,2 의 네 번째 자리 1를 입력해주세요.";
const page20 = "2,0,2,1,1,2 의 다섯 번째 자리 1를 입력해주세요.";
const page21 = "2,0,2,1,1,2 의 여섯 번째 자리 2를 입력해주세요.";
const page22 = "거래 승인번호 2,0,2,1,1,2를 다시 한번 입력해 주세요. 2,0,2,1,1,2의 첫 번째 자리 2를 입력해 주세요.";
const page23 = "2,0,2,1,1,2 의 두 번째 자리 0를 입력해주세요.";
const page24 = "2,0,2,1,1,2 의 세 번째 자리 2를 입력해주세요.";
const page25 = "2,0,2,1,1,2 의 네 번째 자리 1를 입력해주세요.";
const page26 = "2,0,2,1,1,2 의 다섯 번째 자리 1를 입력해주세요.";
const page27 = "2,0,2,1,1,2 의 여섯 번째 자리 2를 입력해주세요.";
const page28 =
    "비밀번호 설정이 완료되었습니다. 비플제로페이를 사용할 준비가 완료되었습니다. 다음 시간에는 비플제로페이에 계좌를 연결하는 실습을 진행하겠습니다.";
