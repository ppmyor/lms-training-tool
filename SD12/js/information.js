...
const page16 = "지하철만 이용해서 도착지로 가는 3개의 경로를 제안합니다. 이번에는 대중교통이 아닌 자동차를 이용한 경로 확인을 위해 검색창 아래 파란색 버스 모양 아이콘 오른쪽 자동차 모양 아이콘을 눌러주세요.";
const page17 = "자동차로 올림픽대로를 이용하는 28분이 소요되는 경로를 제안하고 있습니다. 이번에는 도보로 이동하는 경로를 확인하겠습니다. 자동차 아이콘 오른쪽 사람이 걷는 모양 아이콘을 눌러주세요.";
