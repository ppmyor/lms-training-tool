...
const page1 = "지도 앱을 활용해서 보다 편하고 정확한 길 찾기를 실습하겠습니다. 실습에서는 남부터미널 역 3호선에서 서울디지털재단까지 가는 길을 찾아보겠습니다. 화면을 눌러서 다음 페이지로 진행해 주세요.";
const page2 = "네이버 지도를 최초 실행하면 나오는, 기능과 활용법을 소개하는 튜토리얼 화면입니다. 내용을 확인하고 화면 상단 오른쪽에 화살표를 눌러서 다음으로 진행해 주세요.";
const page3 = "지도 앱의 내비게이션 기능과 특장점을 소개하는 화면입니다. 화면 상단 오른쪽에 화살표를 눌러서 다음으로 진행해 주세요.";
const page4 = "추천 기능 소개 화면입니다. 최초 실행 시에만 튜토리얼 화면이 실행됩니다. 화면 하단에 파란색 시작하기 버튼을 눌러주세요.";
const page5 = "지도 앱은 휴대폰의 위치 정보 GPS를 허용하면 보다 편리한 이용이 가능합니다. 실습에서는 위치 정보를 허용하겠습니다. 허용을 눌러주세요.";
const page6 = "공지, 이벤트 정보 알림 기능은 허용하지 않더라도 지도 서비스 이용에 제한은 없습니다. 내용을 확인하고 예 또는 아니요를 선택해 주세요.";
const page7 = "지도 앱의 첫 화면입니다. 화면 상단에 장소, 버스, 지하철, 주소를 검색할 수 있습니다. 검색창 바로 오른쪽, 파란색 길 찾기 버튼을 눌러주세요.";
const page8 = "길 찾기 화면에서 출발지와 도착지를 설정하고 이동 수단을 선택해서 검색합니다. 출발지에 새로운 장소를 등록하겠습니다. 출발지 입력을 눌러주세요.";
...
const page14 = "길 찾기 검색 결과입니다. 대중교통을 이용한 길 찾기 결과이므로 도착지 입력창 아래 파란색 버스 모양 아이콘이 선택되어 있습니다. 최적 경로는 지하철과 버스를 이용한 결과입니다. 버스만 이용해서 목적지로 가는 경로를 확인하기 위해 파란색 버스 아이콘 아래 전체 버튼 오른쪽 버스 버튼을 눌러주세요.";
const page15 = "버스만 이용해서 도착지로 가는 3개의 경로를 제안합니다. 이번에는 지하철만 이용해서 목적지에 가는 경로 확인을 위해 버스 버튼 오른쪽 지하철 버튼을 눌러주세요.";
const page16 = "지하철만 이용해서 도착지로 가는 3개의 경로를 제안합니다. 이번에는 대중교통이 아닌 자동차를 이용한 경로 확인을 위해 검색창 아래 파란색 버스 모양 아이콘 오른쪽에 있는 자동차 모양 아이콘을 눌러주세요.";
const page17 = "자동차로 올림픽대로를 이용하는 28분이 소요되는 경로를 제안하고 있습니다. 이번에는 도보로 이동하는 경로를 확인하겠습니다. 자동차 아이콘 오른쪽에 있는 사람이 걷는 모양 아이콘을 눌러주세요.";
const page18 = "도보로는 4시간 58분 소요되는 경로를 제안합니다. 마지막으로 자전거를 이용한 이동 경로를 확인해 보겠습니다. 자전거 모양 아이콘을 눌러주세요.";
const page19 = "자전거를 이용한 1시간 17분 소요 예상되는 경로를 제안합니다. 지도 앱을 활용해서 보다 편리하게 이동하세요.";
