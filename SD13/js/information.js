...
const page1 = "지도 앱에 집, 회사, 학교, 병원과 같은 자주 방문하는 장소 등록을 실습하겠습니다. 화면을 눌러서 다음으로 진행해 주세요.";
const page2 = "지도 앱의 홈 화면입니다. 지도 서비스에서 장소 즐겨찾기를 이용하면 등록 한 장소를 클릭 한 번에 출발지나 목적지로 설정할 수 있습니다. 검색창 오른쪽에 파란색 길 찾기 버튼을 클릭해 주세요.";
const page3 = "출발지와 도착지를 입력하고 이동 수단을 선택해서 목적지까지 경로를 검색할 수 있습니다. 자주 방문하는 장소 등록을 위해서 집과 회사 버튼 오른쪽에 화살표 버튼을 눌러주세요.";
const page4 = "즐겨 찾는 장소 화면에서는 집과 회사/학교가 기본 항목으로 등록되어 있고, 추가로 자주 가는 장소를 등록할 수 있는 버튼이 있습니다. 집 설정을 위해 집 버튼을 눌러주세요.";
const page5 = "장소 이름을 집이 아닌 다른 명칭으로 변경할 수 있습니다. 실습에서는 집으로 유지하겠습니다. 집으로 등록할 장소를 지정하겠습니다. '장소를 지정해 주세요.' 오른쪽에 더하기 버튼을 눌러주세요.";
const page6 = "검색창에 집으로 등록할 장소의 주소나 명칭을 검색해서 등록합니다. 실습에서는 검색창에 '서울디지털재단'을 입력하고 엔터 또는 확인을 눌러주세요.";
const page7 = "검색된 목록에서 원하는 장소를 선택합니다.  실습에서는 검색 제안 세 번째 줄의 서울디지털재단을 눌러서 선택해 주세요.";
const page8 = "집에 서울디지털재단이 지정되었습니다. 화면 하단 파란색 저장 버튼을 눌러서 집 등록을 완료해 주세요.";
const page9 = "집으로 서울디지털재단이 등록되었습니다. 이어서 자주 방문하는 병원을 자주 가는 장소에 등록하겠습니다. 자주 가는 장소에서 등록 버튼을 눌러주세요.";
const page10 = "저장할 장소의 별명을 병원으로 입력하겠습니다. '별명을 입력해 주세요.'를 눌러서 병원을 입력하고 엔터 또는 확인을 눌러주세요.";
const page11 = "장소의 별명이 병원으로 입력되었습니다. 장소를 지정하겠습니다. '장소를 지정해주세요.' 오른쪽에 더하기 버튼을 눌러주세요.";
const page12 = "검색창에 집으로 등록할 장소의 주소나 명칭을 검색해서 등록합니다. 실습에서는 검색창에 '국립중앙의료원'을 입력하고 엔터 또는 확인을 눌러주세요.";
const page13 = "검색된 목록에서 원하는 장소를 선택합니다.  실습에서는 검색 제안 네 번째 줄의 국립중앙의료원을 눌러서 선택해 주세요.";
const page14 = "병원에 국립중앙의료원이 지정되었습니다. 화면 하단 파란색 저장 버튼을 눌러서 집 등록을 완료해 주세요.";
const page15 = "집과 병원이 등록되었습니다.자주 방문하는 장소를 활용해서 길 찾기를 실습하겠습니다. 화면 상단 왼쪽에 뒤로 가기 화살표 버튼을 눌러주세요.";
const page16 = "출발지는 보통 현재 위치가 지정됩니다. 실습에서는 서울디지털재단이 출발지로 자동 지정되었습니다. 검색 없이 도착지를 설정하기 위해 검색창 아래 병원 버튼을 눌러주세요.";
const page17 = "도착지에 국립중앙의료원이 등록되고 경로 검색까지 완료됩니다. 지도 앱에서 자주 방문하는 장소를 등록하고 활용하세요.";
