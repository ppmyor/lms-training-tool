...
const page10 = "저장할 장소의 별명을 병원으로 입력하겠습니다. 깃발 아이콘 오른쪽의 입력폼을 눌러서 병원을 입력하고 엔터 또는 확인을 눌러주세요.";
const page11 = "장소의 별명이 병원으로 입력되었습니다. 장소를 지정하겠습니다. '장소를 지정해주세요.' 오른쪽에 더하기 버튼을 눌러주세요.";
const page12 = "검색창에 병원으로 등록할 장소의 주소나 명칭을 검색해서 등록합니다. 실습에서는 검색창에 '국립중앙의료원'을 입력하고 엔터 또는 확인을 눌러주세요.";
