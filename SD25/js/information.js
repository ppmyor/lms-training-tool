...
const page1 =
    "이번 시간에는 간편인증을 위해 패스 인증서 발급을 실습하겠습니다. 패스앱은 통신사에서 제공하는 인증 서비스입니다. 금융기관 및 공공기관에서 본인 확인 시 간편하게 사용 할 수 있습니다. 패스앱 실행을 위하여, 화면을 눌러 다음 화면으로 진행해주세요.";
const page2 =
    "본인 인증을 위해 본인 확인 정보를 등록하겠습니다. 이름과 주민등록번호 앞자리, 주민등록번호 뒤 첫 자리, 그리고 휴대폰 번호 입력이 필요합니다. 실습에서는 이름은 김서울, 주민등록번호 정보는 480101, 주민등록번호 뒷자리 첫 번째에는 1, 그리고 전화번호는  010-1234-5678 을 입력하겠습니다. 화면을 눌러서 다음 단계로 진행해주세요.";
const page3 =
    "본인 확인 정보 입력을 완료하고, 입력 정보가 제시된 정보와 다르면 진행되지 않습니다. 입력된 정보를 확인해 주세요. 확인하시고, 화면 하단 검은색 다음 버튼을 눌러주세요.";
const page4 =
...
const page6 =
    "인증 번호가 인증 시 입력한 휴대폰 번호로 전송되었습니다. 인증 번호가 제대로 전송되지 않았다면 재전송을 누르면 다시 받을 수 있습니다. 인증번호에 759774를 입력해주세요.";
...
const page10 =
    "이번 실습에서 비밀번호는 2,0,2,1,1,2를 입력하겠습니다. 숫자 자판을 이용해서 202112의 첫 번째 자리 2를 입력해주세요.";
const page11 =
    "이번 실습에서 비밀번호는 2,0,2,1,1,2를 입력하겠습니다. 숫자 자판을 이용해서 202112의 두 번째 자리 0을 입력해 주세요.";
const page12 =
    "이번 실습에서 비밀번호는 2,0,2,1,1,2를 입력하겠습니다. 숫자 자판을 이용해서 202112의 세 번째 자리 2를 입력해 주세요.";
const page13 =
    "이번 실습에서 비밀번호는 2,0,2,1,1,2를 입력하겠습니다. 숫자 자판을 이용해서 202112의 네 번째 자리 1을 입력해 주세요.";
const page14 =
    "이번 실습에서 비밀번호는 2,0,2,1,1,2를 입력하겠습니다. 숫자 자판을 이용해서 202112의 다섯 번째 자리 1을 입력해 주세요.";
const page15 =
    "이번 실습에서 비밀번호는 2,0,2,1,1,2를 입력하겠습니다. 숫자 자판을 이용해서 202112의 여섯 번째 자리 2를 입력해 주세요.";
const page16 =
    "비밀번호를 한 번 더 입력하는 단계입니다. 반드시 처음 입력 한 비밀번호와 같은 비밀번호를 한 번 더 입력해 주셔야 합니다. 숫자 자판을 이용해서 처음 입력한 비밀번호 202112의 첫 번째 자리 2를 입력해 주세요.";
...
const page19 = "숫자 자판을 이용해서 처음 입력한 비밀번호 2,0,2,1,1,2의 네 번째 자리 1을 입력해 주세요.";
