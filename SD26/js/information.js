...
const page1 =
    "패스 앱 가입에 이어서, 금융기관, 공공기관 그리고 각종 웹사이트에서 인증수단으로 사용 가능한 패스 인증서 등록을 실습하겠습니다. 패스 인증서를 등록하기 위해서 패스 앱 첫 화면에서 인증서 관리 버튼을 눌러주세요.";
const page2 =
    "인증서 관리 화면입니다. 발급받은 인증서가 없을 경우 화면과 같이 새로운 인증서 발급 버튼과 인증 대기 목록을 확인할 수 있습니다. 패스 인증서 발급하기 영역을 눌러주세요.";
const page3 =
    "공동 인증서보다 더 간편한 패스 인증서 발급을 위한 약관 동의 절차입니다. 선택 항목은 체크하지 않고 인증서 발급을 진행하겠습니다. 서비스 이용을 위해 필수로 동의가 필요한 '서비스 필수 항목 모두 동의'에 체크해 주세요.";
const page4 =
    "서비스 필수 항목 모두 동의에 체크되었습니다. 선택 항목은 동의하지 않고 진행하겠습니다. 화면 하단 검은색 발급하기 버튼을 눌러주세요.";
const page5 =
    "인증서 발급을 위해서, 회원가입 실습 시 입력했던 비밀번호 2 0 2 1 1 2를 입력하겠습니다. 번호 자판을 이용하여 비밀번호 첫 번째 자리 2를 눌러주세요.";
const page6 = "번호 자판을 이용하여 비밀번호 두 번째 자리 0을 눌러주세요.";
const page7 = "번호 자판을 이용하여 비밀번호 세 번째 자리 2을 눌러주세요.";
const page8 = "번호 자판을 이용하여 비밀번호 네 번째 자리 1을 눌러주세요.";
const page9 = "번호 자판을 이용하여 비밀번호 다섯 번째 자리 1을 눌러주세요.";
const page10 = "번호 자판을 이용하여 비밀번호 여섯 번째 자리 2를 눌러주세요.";
