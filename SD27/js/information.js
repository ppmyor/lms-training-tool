...
const page2 = "결제할 상품들의 바코드를 찾아 스캐너로 스캔해 주세요. 실습에서는 화면을 눌러서 스캔을 대신하겠습니다.";
const page3 =
    "스카치 테이프 1개가 스캔되었습니다. 스캔한 제품과 스캔하지 않은 제품이 잘 구분되도록 스캔한  제품은 꼭 포장대 위로 이동하여 놓아주세요.";
const page4 =
...
const page5 = "결제할 상품들의 바코드를 찾아 스캐너로 스캔해 주세요. 실습에서는 화면을 눌러서 스캔을 대신하겠습니다.";
const page6 = "자두맛 캔디 1개가 스캔되었습니다. ";
const page7 = "스캔한 제품과 스캔하지 않은 제품이 잘 구분되도록 스캔한  제품은 꼭 포장대 위로 이동하여 놓아주세요";
const page8 = "포장대로 이동한 상품과 가격을 확인하고 결제하기를 눌러 주세요.";
const page9 =
    "포인트 적립 및 사용 화면입니다. 실습에서는 휴대폰 번호를 이용해 포인트를 적립하겠습니다. 휴대폰 번호 입력을 눌러주세요.";
const page10 = "휴대폰 번호를 입력하겠습니다. 휴대폰 번호를 숫자만 입력하고 엔터 또는 확인을 눌러주세요.";
const page11 = "휴대폰번호가 입력되었습니다. 확인을 눌러 포인트 적립을 완료해 주세요.";
const page12 =
    "입력한 번호와 함께 회원 정보를 확인할 수 있습니다. 포인트 적립을 완료하고, 쇼핑하기를 눌러 다음으로 이동해 주세요.";
const page13 =
    "물건 값 1,200원을 결제할 수단을 선택해 주세요. 실습에서는 신용 카드로 결제하겠습니다. 신용 카드 버튼을 눌러 주세요.";
const page14 = "결제할 카드를 꺼내 카드 투입구에 넣어 주세요";
const page15 = "카드의 IC칩이 인식될 수 있도록, 투입구 끝까지 밀어 넣어 주세요.";
const page16 =
    "승인 중입니다. 카드가 승인되고 결제 완료 화면이 나올 때까지 카드를 빼지 말고 기다려 주세요. 결제 과정에서 모니터에 나오는 지시 사항을 잘 확인해서 대응해주세요. 카드를 인식하지 못하는 경우 카드를 뺐다가 다시 넣어주시면 됩니다. 화면을 눌러서 다음으로 이동해 주세요.";
>>>>>>> 31972a8c6a91df2b79c996af61fe512cedea93ae
