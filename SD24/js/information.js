...
const page12 = "미리 등록해놓은 계좌가 보이고 있습니다. 화면의 오른쪽에, QR코드 그림 밑에 보이는 결제하기를 눌러주세요.";
const page13 = "은행 계좌에서 결제된다는 메시지와 함께, QR코드를 인식할 수 있는 화면과, 바코드 그림이 보이고 있습니다. 화면 하단의 바코드 그림을 눌러서, 다음으로 진행해 주세요.";
const page14 = "이제, 비플제로페이 앱에서 생성된 바코드와 QR코드를 확인할 수 있습니다. 그럼, 바코드와 QR코드를 통해 결제하는 방법을 확인하기 위해, 화면을 눌러서 다음으로 진행해 주세요.";
const page15 = "가맹점에서 물건을 구매할 때, 바코드나 QR코드를 매장 카운터에 보여주면, 직원이 이 바코드를 인식해서 결제를 진행하게 됩니다. 결제를 한 다음, 영수증은 어떻게 나타나는지, 다음 화면에서 확인해 보겠습니다. 화면을 눌러주세요.";
const page16 = "서울디지털재단 가게에서 8,800원의 상품을 구매했다는 영수증이 발급되었습니다. 이제 닫기를 눌러서, 다음 결제 방법을 실습해 보겠습니다. 닫기를 눌러주세요.";
const page17 = "두 번째 방법은, 가맹점에서 상품을 구매할 때, 가맹점에 부착되어 있는 QR코드 이미지를 활용해서, 결제를 진행하는 방법입니다. 실습을 위해, 화면을 눌러서 다음으로 진행해 주세요.";
const page18 = "계좌에서 제로페이 결제를 눌러주세요.";
const page19 = "미리 등록해놓은 계좌가 보이고 있습니다. 화면의 오른쪽에, QR코드 그림 밑에 보이는 결제하기를 눌러주세요.";
const page20 = "은행 계좌에서 결제된다는 메시지와 함께, QR코드를 인식할 수 있는 화면과, 바코드 그림이 보이고 있습니다. 이번에는, 가맹점에 설치된 QR코드를 화면에 인식시켜보겠습니다. QR코드 그림을 눌러주세요.";
const page21 = "가맹점의 정보가 인식되었습니다. 비플제로페이 가맹점으로 등록된 매장이라면, 이렇게 비플제로페이 앱을 활용해서 결제를 진행할 수 있습니다. 이제, 결제를 진행하기 위해서, 금액을 입력해 보겠습니다. 결제금액 입력폼을 눌러서 12300원을 입력해주세요.";
...
const page24 = "서울디지털재단 가게에서 12,300원의 상품을 구매했다는 영수증이 발급되었습니다. 이제, 비플제로페이 앱을 활용해서, 보다 편리한 소비생활을 누려보세요. 이것으로 실습을 종료하겠습니다.";
